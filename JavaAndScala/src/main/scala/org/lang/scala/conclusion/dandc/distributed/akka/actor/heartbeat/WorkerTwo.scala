...
object WorkerTwo {
  ...
  def apply(workerHost: String, workerPort: Int, masterHost: String, masterPort: Int) = {
    ...
    val totalCores = 2
    val totalMemSize = 1024l
    val workerProps = Props(classOf[WorkerTwo], masterHost, masterPort, workerHost, workerPort, totalCores, totalMemSize)
    actorSys.actorOf(workerProps, "WorkerTwo")
  }
