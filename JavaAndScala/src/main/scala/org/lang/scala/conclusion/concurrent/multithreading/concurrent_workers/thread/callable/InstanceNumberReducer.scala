package org.lang.scala.conclusion.concurrent.multithreading.concurrent_workers.thread.callable
 ...
 * 	@author VinceYuan
 */
class InstanceNumberReducer extends Callable[Boolean] {
  ...
  override def call() = {
    ...
    /*	Return the signal that signifies the computed result	*/
    true
  }
}