...
/**
 * 	This is a stand-alone object to test cached thread pool with wrapper and utility classes
 ...
 *  @author VinceYuan
 */
object TestCachedThreadPoolWithWrapperAndUtil {
  ...
  def main(args: Array[String]): Unit = {
    testCachedThreadPoolWithWrapperAndUtil()
  }
  
  /**
   * 	This is a method to test cached thread pool with wrapper and utility classes
   *  -- To check the concurrency effect clearly, can run this method for a couple of times
   */
  private def testCachedThreadPoolWithWrapperAndUtil(): Unit = {
