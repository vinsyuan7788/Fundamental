 ...
 *
 */
public class LineNumberSemicolonBufferedReader extends BufferedReader {

	/*	This is the line number with initial value 1 for enhancement	 */
	private int lineNumber = 1;
	
	/*	Here inherits one of the parent constructors	*/
	public LineNumberSemicolonBufferedReader(Reader in) {
		super(in);
	}
	
	/**
	 * 	Override the "readLine()" method for enhancement: 
	 * 	-- Aims to add the line number ahead of each line & add the semicolon at the end of each line	
	 */
	@Override
