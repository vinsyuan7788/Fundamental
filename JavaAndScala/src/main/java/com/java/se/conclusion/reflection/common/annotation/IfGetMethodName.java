package com.java.se.conclusion.reflection.common.annotation;
...
/**
 * 	This is an annotation class to control if the method name is obtained or not
...
public @interface IfGetMethodName {
