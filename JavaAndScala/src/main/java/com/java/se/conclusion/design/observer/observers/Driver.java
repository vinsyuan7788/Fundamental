 ...
 *
 */
public class Driver implements WeatherNotifier {
	...
	public void takeActionAccordingToCurrentWeather(String currentWeather) {
		...
		case "sunny":
			System.out.println("Driver " + name + " can work happily.");
			break;
		case "hazy":
			System.out.println("Driver " + name + " can work with a mask.");
			break;
		case "windy":
			System.out.println("Driver " + name + " can work with an umbrealla.");
			break;
		case "hailing":
			System.out.println("Driver " + name + " can work inside a car.");
			break;
		case "snowy":
			System.out.println("Driver " + name + " can work with warm clothes.");
			break;
		default:
			break;
		}
